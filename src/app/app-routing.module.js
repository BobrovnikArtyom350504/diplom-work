...
var routes = [
    ...
    { path: 'code-editor', component: code_editor_component_1.CodeEditorComponent },
    { path: 'simulator', component: simulator_component_1.SimulatorComponent },
    { path: 'map-constructor', component: map_constructor_component_1.MapConstructorComponent }
];
